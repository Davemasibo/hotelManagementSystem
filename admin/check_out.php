...
<div class="container-fluid py-3">
  ...
  <div class="page-header mb-4">
    <h5 class="page-title"><i class="fa fa-sign-out-alt mr-2"></i>Check-Out / Records</h5>
  </div>

  <div class="card">
    <div class="card-body p-0">
      <table class="table table-hover mb-0" id="checkout-table">
        <thead>
          <tr>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php echo htmlspecialchars($cat_arr[$room_arr[$row['room_id']]['category_id']]['name'] ?? '—'); ?></td>
            <td><?php echo htmlspecialchars($room_arr[$row['room_id']]['room'] ?? '—'); ?></td>
