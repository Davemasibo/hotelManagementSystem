...
<div class="container-fluid py-3">
  ...
  <div class="page-header mb-4">
    <h5 class="page-title"><i class="fa fa-comment-dots mr-2"></i>Guest Requests</h5>
    <div>
      <select id="status-f" class="custom-select custom-select-sm" style="width:auto">
    ...
    <div class="card-body p-0">
      <table class="table table-hover mb-0" id="req-table">
        ...
        <tr>
          <td><?php echo $n++; ?></td>
          <td>
            <?php echo htmlspecialchars($gname); ?><br>
            <small class="text-muted">
              <?php echo htmlspecialchars($r['room'] ?? '—'); ?> &bull; <?php echo htmlspecialchars($r['ref_no']); ?>
            </small>
          </td>
          <td><span class="badge badge-secondary"><?php echo ucwords(str_replace('_', ' ', $r['request_type'])); ?></span></td>
          <td>
            <?php echo htmlspecialchars(mb_substr($r['description'], 0, 80)); ?>
            <?php if (strlen($r['description']) > 80) echo '…'; ?>
          </td>
